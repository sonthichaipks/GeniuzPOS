...
//
//     final getActivePosStation = getActivePosStationFromJson(jsonString);

import 'dart:convert';

List<GetActivePosStation> getActivePosStationFromJson(String str) =>
    List<GetActivePosStation>.from(
        json.decode(str).map((x) => GetActivePosStation.fromJson(x)));

String getActivePosStationToJson(List<GetActivePosStation> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetActivePosStation {
  GetActivePosStation({
    this.id,
    this.posId,
    this.posPermitNo,
  ...
  factory GetActivePosStation.fromJson(Map<String, dynamic> json) =>
      GetActivePosStation(
        id: json["id"],
        posId: json["posId"],
        ...
        whsId: json["whsId"],
        lastReceiptRunNo:
            (json["lastReceiptRunNo"] == null) ? 0 : json["lastReceiptRunNo"],
        lastRefundRunNo:
            (json["lastRefundRunNo"] == null) ? 0 : json["lastRefundRunNo"],
        cashierPosFg: (json["cashierPosFg"] == null) ? 1 : json["cashierPosFg"],
        posScreenType: json["posScreenType"],
        posTouchPanelId: json["posTouchPanelId"],
        maxCashInDrawer: (json["maxCashInDrawer"] == null)
            ? 1000.00
            : json["maxCashInDrawer"].toInt(),
