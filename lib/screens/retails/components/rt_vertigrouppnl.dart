...
class RtproductGroupPanel extends StatefulWidget {
  final double starttop;
  final double startleft;
  final GrpPnlBtnListCallback pnlbtnInputs;

  const RtproductGroupPanel({
    Key key,
  ...
  @override
  _RtproductGroupPanel createState() => _RtproductGroupPanel();
}

class _RtproductGroupPanel extends State<RtproductGroupPanel> {
  @override
  void dispose() {
    super.dispose();
  }
                ...
                child: SingleChildScrollView(
                  child: Theme(
                    ...
                    child: DataTable2(
                      ...
                      rows: List<DataRow>.generate(stdButtuon4.length, (index) {
