...
import 'package:com_csith_geniuzpos/screens/panel_config/components/pnlConfig_fb.dart';
...
import 'components/rest_body.dart';
import 'components/rest_grouppnl.dart';
import 'components/rest_grppnl.dart';
import 'components/rest_salesitem.dart';

class ResturantSalesPages extends StatefulWidget {
  @override
  _ResturantSalesPages createState() => _ResturantSalesPages();
}

class _ResturantSalesPages extends State<ResturantSalesPages>
    implements
        PosFncCallBack,
        PosFncAddFree,
        PosFncAddNew,
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        child: Scaffold(
          body: restScreenDesktop(context, _responseInput, salesitemsum),
        ));
  }

  Widget restScreenDesktop(BuildContext context,
      PosFncCallResponse responseInput, SalesItemSummary salesitemsum) {
    return Stack(children: [
      frameBUtton(context),
      ResturantSalesSummaryPages(),
      Positioned(
  ...
  void onCallPosFncGetItemSuccess(SalesItems asalesitem) {
    setState(() {
      ...
      if (asalesitem.plu.isNotEmpty) {
        //  normalDialog(_context, _posinput.txt9.text);
